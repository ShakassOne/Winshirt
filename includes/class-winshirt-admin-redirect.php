...
class WinShirt_Admin_Redirect {
    ...
    public function hide_editor_completely() {
        ...
        setTimeout(function() {
            <?php if ( $post_type === 'winshirt_mockup' ): ?>
                window.location.href = '<?php echo admin_url('admin.php?page=winshirt-mockups'); ?>';
            <?php elseif ( $post_type === 'winshirt_visual' ): ?>
                window.location.href = '<?php echo admin_url('admin.php?page=winshirt-visuals'); ?>';
            <?php elseif ( $post_type === 'winshirt_lottery' ): ?>
                window.location.href = '<?php echo admin_url('admin.php?page=winshirt-lotteries'); ?>';
            <?php endif; ?>
        }, 2000);
        </script>
        ...
        <div class="winshirt-redirect-notice">
            ...
            <p>
                <?php if ( $post_type === 'winshirt_mockup' ): ?>
                    <a href="<?php echo admin_url('admin.php?page=winshirt-mockups'); ?>" class="button button-primary">
                        Aller aux Mockups
                    </a>
                <?php elseif ( $post_type === 'winshirt_visual' ): ?>
                    <a href="<?php echo admin_url('admin.php?page=winshirt-visuals'); ?>" class="button button-primary">
                        Aller aux Visuels
                    </a>
                <?php elseif ( $post_type === 'winshirt_lottery' ): ?>
                    <a href="<?php echo admin_url('admin.php?page=winshirt-lotteries'); ?>" class="button button-primary">
                        Aller aux Loteries
                    </a>
                <?php endif; ?>
            </p>
